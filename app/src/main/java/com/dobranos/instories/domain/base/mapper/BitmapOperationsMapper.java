...
public class BitmapOperationsMapper
{
    ByteBuffer _handler = null;

    static
    {
        System.loadLibrary("BitmapOperationsMapper");
    }
    ...
    public BitmapOperationsMapper()
    {}

    public BitmapOperationsMapper(final Bitmap bitmap)
    {
        storeBitmap(bitmap);
    }
