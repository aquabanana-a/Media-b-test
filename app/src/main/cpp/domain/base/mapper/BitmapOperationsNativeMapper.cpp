//
// Created by Andromeda on 29.10.2019.
//
// see https://github.com/AndroidDeveloperLB/AndroidJniBitmapOperations
...
extern "C"
    {
//store
    JNIEXPORT jobject JNICALL Java_com_dobranos_instories_domain_base_mapper_BitmapOperationsMapper_jniStoreBitmapData(
	    JNIEnv * env, jobject obj, jobject bitmap);
//get
    JNIEXPORT jobject JNICALL Java_com_dobranos_instories_domain_base_mapper_BitmapOperationsMapper_jniGetBitmapFromStoredBitmapData(
	    JNIEnv * env, jobject obj, jobject handle);
//free
    JNIEXPORT void JNICALL Java_com_dobranos_instories_domain_base_mapper_BitmapOperationsMapper_jniFreeBitmapData(
	    JNIEnv * env, jobject obj, jobject handle);
//rotate 90 degrees CCW
    JNIEXPORT void JNICALL Java_com_dobranos_instories_domain_base_mapper_BitmapOperationsMapper_jniRotateBitmapCcw90(
	    JNIEnv * env, jobject obj, jobject handle);
//rotate 90 degrees CW
    JNIEXPORT void JNICALL Java_com_dobranos_instories_domain_base_mapper_BitmapOperationsMapper_jniRotateBitmapCw90(
	    JNIEnv * env, jobject obj, jobject handle);
//rotate 180 degrees
    JNIEXPORT void JNICALL Java_com_dobranos_instories_domain_base_mapper_BitmapOperationsMapper_jniRotateBitmap180(
	    JNIEnv * env, jobject obj, jobject handle);
//crop
    JNIEXPORT void JNICALL Java_com_dobranos_instories_domain_base_mapper_BitmapOperationsMapper_jniCropBitmap(
	    JNIEnv * env, jobject obj, jobject handle, jint left,
		jint top, jint right, jint bottom);
//scale using nearest neighbor
    JNIEXPORT void JNICALL Java_com_dobranos_instories_domain_base_mapper_BitmapOperationsMapper_jniScaleNNBitmap(
	    JNIEnv * env, jobject obj, jobject handle, jint newWidth,
		jint newHeight);

//scale using Bilinear Interpolation
    JNIEXPORT void JNICALL Java_com_dobranos_instories_domain_base_mapper_BitmapOperationsMapper_jniScaleBIBitmap(
	    JNIEnv * env, jobject obj, jobject handle, jint newWidth,
		jint newHeight);

    JNIEXPORT void JNICALL Java_com_dobranos_instories_domain_base_mapper_BitmapOperationsMapper_jniFlipBitmapHorizontal(
	    JNIEnv * env, jobject obj, jobject handle);

    JNIEXPORT void JNICALL Java_com_dobranos_instories_domain_base_mapper_BitmapOperationsMapper_jniFlipBitmapVertical(
	    JNIEnv * env, jobject obj, jobject handle);
    }
...
JNIEXPORT void JNICALL Java_com_dobranos_instories_domain_base_mapper_BitmapOperationsMapper_jniCropBitmap(
	JNIEnv * env, jobject obj, jobject handle, jint left, jint top,
